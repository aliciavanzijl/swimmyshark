...
![demo](./shark_game_short.gif)  

It is based on a project template provided by IS1200 teachers.
Some functions were copied from lab files and documentation, these have been
marked as such in the comments.

Makefile provided by IS1200.

The template provided by IS1200 contained the following source files:
